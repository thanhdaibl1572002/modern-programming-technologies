...
let forms = [
    [
        ...
        {
            id: 5, name: 'gender', label: 'Giới tính', type: 'radio-group', value: '', error: 'Không được để trống',
            radios: [
    ...
    [
        ...
        { id: 12, name: 'religion', label: 'Tôn giáo', placeholder: 'vd: Phật Giáo', type: 'text', regex: /^.+$/, error: 'Không được để trống', },
    ],
    [
    ...
    [
        ...
        { id: 27, name: 'highestProfessionalLevel', label: 'Trình độ chuyên môn cao nhất', placeholder: 'vd: Tiến sĩ', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 28, name: 'politicalTheory', label: 'Lý luận chính trị', placeholder: 'vd: Cử nhân', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 29, name: 'stateManagement', label: 'Quản lý nhà nước', placeholder: 'vd: Chuyên viên cao cấp', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 30, name: 'professionalCompetence', label: 'Trình độ nghiệp vụ theo chuyên ngành', placeholder: 'vd: Kỹ thuật phần mềm', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 31, name: 'foreignLanguage', label: 'Ngoại ngữ', placeholder: 'vd: Tiếng Anh TOEIC 990', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 32, name: 'computerSkills', label: 'Tin học', placeholder: 'vd: Kỹ năng 01 đến Kỹ năng 15', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
    ],
    [
        ...
        { id: 35, name: 'politicalSocialOrganization', label: 'Tham gia tổ chức  chính trị - xã hội', placeholder: 'vd: Đảng cộng sản Việt Nam', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        ...
        { id: 38, name: 'highestMilitaryRank', label: 'Quân hàm cao nhất', placeholder: 'vd: Đại úy', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 39, name: 'highestAward', label: 'Danh hiệu được phong tặng cao nhất', placeholder: 'vd: Nhà giáo ưu tú', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 40, name: 'academicRank', label: 'Học hàm được phong', placeholder: 'vd: Giáo sư', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 41, name: 'disciplinaryAction', label: 'Kỷ luật cao nhất', placeholder: 'vd: Khai trừ Đảng viên', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 42, name: 'commendation', label: 'Khen thưởng cao nhất', placeholder: 'vd: Huân chương lao động hạng 3', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
    ],
    [
        { id: 43, name: 'workStrength', label: 'Sở trường công tác', placeholder: 'vd: Giảng dạy', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 44, name: 'healthStatus', label: 'Tình trạng sức khoẻ', placeholder: 'vd: Sức khỏe tốt', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        ...
        { id: 48, name: 'socialInsuranceBook', label: 'Sổ BHXH', placeholder: 'vd: 1234567890', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 49, name: 'identityCardNumber', label: 'Số chứng minh / căn cước', placeholder: 'vd: 025689743', type: 'text', regex: /^.+$/, error: 'Không được để trống' },
        { id: 50, name: 'idIssueDate', label: 'Ngày cấp chứng minh / căn cước', type: 'date', regex: /^.+$/, error: 'Không được để trống' },
        { id: 51, name: 'policyFamily', label: 'Là con gia đình chính sách', placeholder: 'vd: Con thương binh', type: 'text' },
        { id: 52, name: 'disabilityRank', label: 'Là thương binh hạng', placeholder: 'vd: Thương binh hạng 2', type: 'text' },
    ],
    [
        {
